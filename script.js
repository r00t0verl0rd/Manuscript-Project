...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('about-btn')?.addEventListener('click', () => {
    ...
    // Обработчик клика не несёт функционала (только no-op), убран для чистоты.
  ...
  const mockIdeas = [
    {
      text: 'Умное распределение бюджета. В центре каждого города монитор, как котором происходит голосование жителей через приложение, на что в даннный момент важнее пустить ресурсы',
      likes: 12950,
    ...
    {
      text: 'Нужно из каджой страны взять лучие законы, которые реально работают на пользу, объеденить их и тем самым создать одну страну на всех, убрав искуственные границы. Планета Земля - на ней живут Земляне. Всё просто)',
      likes: 10113,
